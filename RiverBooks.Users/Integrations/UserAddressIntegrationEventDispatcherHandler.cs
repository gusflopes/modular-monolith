...
internal class UserAddressIntegrationEventDispatcherHandler : INotificationHandler<AddressAddedEvent>
{
  ...
  public async Task Handle(AddressAddedEvent notification, CancellationToken cancellationToken)
  {
    ...
    var addressDetails = new UserAddressDetails(
      ...
      notification.NewAddress.StreetAddress.Street,
      ...
      notification.NewAddress.StreetAddress.ZipCode,
    ...
    _logger.LogInformation("[DE Handler]New address integration event sent for user {user}: {address}",
